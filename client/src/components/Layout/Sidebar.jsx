...
const Sidebar = () => {
    ...
    return (
        <aside 
            className={`min-h-screen inset-y-0 left-0 z-40 transition-all duration-300 ease-in-out flex flex-col border-r border-gray-300 bg-gray-100 ${collapsed ? 'w-[70px]' : 'w-[350px]'}`}
        >
