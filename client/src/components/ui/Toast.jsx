...
const Toast = React.forwardRef(({ className, variant, ...props }, ref) => {
  const baseClass =
    "group pointer-events-auto relative flex w-full items-center justify-between space-x-4 overflow-hidden rounded-md border border-gray-300 p-6 pr-8 shadow-lg transition-all";
  const stateClass =
